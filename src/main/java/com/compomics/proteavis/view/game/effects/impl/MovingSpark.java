package com.compomics.proteavis.view.game.effects.impl;
...
public class MovingSpark implements Spark {
	...
	public MovingSpark(FireworksPanel parent, double direction, double x, double y, Color c, long LIFESPAN, double MAX_SPEED) {
